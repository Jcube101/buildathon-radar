...
4. Eligibility genuinely restricted to students. This is different from exclusion 1: exclusion 1 is about who is running the event, this exclusion is about who is allowed to attend, so it applies even when the host or organizer is a general company, community, or platform, not a college. Exclude an event if its eligibility or description states that participation is genuinely restricted to students, currently enrolled individuals, or members of a specific institution, for example "students only," "open only to students," "must be a currently enrolled student," or "for university students only." Do NOT exclude an event that merely mentions students as one part of a broader eligible audience, for example "open to students, professionals, and researchers" or "welcoming students and industry practitioners"; that kind of inclusive mention is not this exclusion, and the event should be scored normally on its own merits. Only genuine restriction to students triggers this rule, not any mention of students."""
